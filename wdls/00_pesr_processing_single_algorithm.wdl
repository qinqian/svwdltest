...
task standardize_vcf {
  ...
  command {
    ...
    svtk standardize --prefix ${algorithm}_${group} --contigs ${contigs} --min-size ${min_svsize} ${raw_vcf} ${algorithm}.${group}.vcf ${algorithm} --call-null-sites ## --include-reference-sites
  }
